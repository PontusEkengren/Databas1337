...
public class Main {
	...
	public static void main(String[] args) {
        ...
        String server = "jdbc:mysql://178.78.213.33:3306/" + database +	"?UseClientEnc=UTF8"; 
        ...
        try {	
			...
			//addArtist(con, "INSERT INTO Lab_1_Music(artist, genre, rating) VALUES('Test1', '2', 7)");
        }
		catch(Exception e) {
	...
	public static void addArtist(Connection con, String query) throws SQLException {
